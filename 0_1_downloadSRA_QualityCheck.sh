...
MyID=aubclsb0304          ## Example: MyID=aubtss
...
##### Extra ####
## If you are downloaded data from a sequencing company instead of NCBI, using wget for example, then calculate the md5sum values of all the files in the folder (./*), and read into a text fi$
