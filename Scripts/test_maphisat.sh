...
CLEAND=/scratch/$MyID/FinalProject/CleanData                      ## Example:/scratch/$MyID/PracticeRNAseq/CleanData20   #   *** This is where the cleaned paired files are located
...
cd $REFD
cp /scratch/aubclsb0323/FinalProject/$REF.fasta .
cp /scratch/aubclsb0323/FinalProject/$REF.gtf .  ### was originally gff3
...
hisat2-build --ss $REF.ss --exon $REF.exon $REF.fasta
