...
DD=/scratch/$MyID/FinalProject/RawData/30s                          ## Example: DD=/scratch/$MyID/PracticeRNAseq/RawData
CD=/scratch/$MyID/FinalProject/CleanData                          ## Example: CD=/scratch/$MyID/PracticeRNAseq/CleanData/30s
CS=PostCleanQuality
